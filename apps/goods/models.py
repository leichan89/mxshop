...
class Goods(models.Model):
    ...
    sold_num = models.IntegerField("商品销售数", default=0)
    ...
    # 首页中展示的商品封面图
    # 存放路径为：MEDIA_ROOT下。upload_to为路径是MEDIA_ROOT/goods/images/下的子目录
    ...
    class Meta:
        verbose_name = "商品信息"
        verbose_name_plural = verbose_name
        # 按照价格升序排序，如果视图类中设置的默认排序方式，这里的排序就不会生效
...
class GoodsImage(models.Model):
    ...
    # 通过商品找到对应的图片信息GoodsImage模型
    # goodsimage = goods.image.all()
    # 获取这个商品对应的图片信息
